        ...
        <div class="d-flex" id="wrapper">
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
					<a class="list-group-item list-group-item-action list-group-item-primary p-3" href="/gestiontransport/client/" >Tableau de bord</a>
					...
					<div class="row">
						<div class="col-11">
							<table class="table table-bordered table-hover table-striped">
								...
								<tbody>
									<?php 
										$sql = "SELECT *, (DATE(NOW()) - INTERVAL 7 DAY) AS diff FROM commande WHERE id_client='".$_SESSION['id_client']."' AND date_commande >= (DATE(NOW()) - INTERVAL 7 DAY) ORDER BY id_commande DESC";
